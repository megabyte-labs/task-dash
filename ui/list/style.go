...
var (
	darkGrayFg = lipgloss.NewStyle().Foreground(darkGray).Render
)
...
func DefaultStyles() (s Styles) {
	...
	s.TabStyle = lipgloss.NewStyle().
		Foreground(lipgloss.AdaptiveColor{Light: "#909090", Dark: "#626262"})
	s.SelectedTabStyle = lipgloss.NewStyle().
		Foreground(lipgloss.AdaptiveColor{Light: "#333333", Dark: "#979797"})
